...
app.use((req, res, next) => {
  ...
  if (req.path === '/api/status' || req.path === '/api/yt/stream' || req.path === '/' || req.path === '/favicon.ico' || req.path.startsWith('/auth/') || req.path.startsWith('/admin') || req.path.startsWith('/api/admin') || req.path.startsWith('/api/updates') || req.path.startsWith('/socket.io') || req.method === 'OPTIONS') return next()
